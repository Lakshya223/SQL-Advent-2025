...
SELECT * 
FROM cocoa_logs JOIN break_schedule JOIN cocoa_types JOIN locations ON
    cocoa_logs.cocoa_id = cocoa_types.cocoa_id AND
    cocoa_logs.break_id = break_schedule.break_id AND
    break_schedule.location_id = locations.location_id
